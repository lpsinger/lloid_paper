...
PREREQS = \
	flop_budget.tex inspiral_svd.tex introduction.tex analysis.tex appendix.tex packages.tex macros.tex method.tex results.tex time_slices.pdf mock_psd.pdf time_slices.tex time_slice_latency.tex references.bib
