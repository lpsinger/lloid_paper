...
PREREQS = \
	figures/bw.pdf figures/bw_resample.pdf resamp_mm.pdf figures/lloid-diagram.pdf figures/upsample-symbol.pdf figures/downsample-symbol.pdf figures/adder-symbol.pdf figures/fir-symbol.pdf flop_budget.tex flop_budget_example.tex inspiral_svd.tex introduction.tex analysis.tex conclusions.tex appendix.tex packages.tex macros.tex method.tex results.tex time_slices.pdf mock_psd.pdf time_slices.tex time_slice_latency.tex references.bib N_before_Tc.pdf
...
resamp_mm.pdf: mm_budget matplotlibrc
	python $<
...
N_before_Tc.pdf: snr_in_time.py matplotlibrc
	python $<
