...
overhead.  Connecting the interpolation filters in cascade fashion rather than
in parallel made a significant difference.  Also, between $N^\shortuparrow = 16$
and $N^\shortuparrow = 192$ the total cost in \flops\ varied across an order of
magnitude.  There is possibly further room for optimization beyond minimizing
$N^\shortuparrow$.  We have considered designing our own custom decimation and
interpolation filters or tuning these filters separately for each time slice.
We now appreciate that the efficiency of \lloid\ hinges on proper specification
of $N^\shortuparrow$.
...
glitch rejection used in previous \GW\ \CBC\ searches.
