...
interpolation filters in cascade fashion rather than in parallel made a
significant difference.  Also, between $N^\shortuparrow = 16$ and
$N^\shortuparrow = 192$ the total cost in \flops\ varied across an order of
magnitude.  We now appreciate that the efficiency of \lloid\ hinges on proper
specification of $N^\shortuparrow$.
