...
$$
%
up to an arbitrary multiplicative constant.  $\tilde{h}[n]$, $\tilde{s}[n]$, and $\tilde{x}[n]$ are the discrete Fourier transforms of $h[k]$, $s[k]$, and $x[k]$, respectively, here $\tilde{S}[n]$ is the power spectral density of $n[k]$.  The discrete Fourier transform of the output is
%
\begin{multline}
