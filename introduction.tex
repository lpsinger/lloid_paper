...
%
\begin{table}
\caption{\label{table:sky-localization-accuracy}Horizon distance, most likely yearly detection rate, and \SNR\ at merger for a source that produces an \SNR\ of 8 in all three detectors at $t$~s before merger.  The fifth and sixth columns show the minimum area of the 90\% confidence region on the sky before merger and at merger.}
