...
\LIGO\ assuming event rates predicted in~\cite{Abadie:2010p10836} and anticipated
detector sensitivity described in \cite{ALIGONoise}.  The
...
\cite{Abadie:2010p10836}.  With an advanced detector in the `zero detuning,
high power' configuration \cite{ALIGONoise} and an \SNR\ threshold of 8,
