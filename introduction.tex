...
\citep{shibata:2007}.  The \GW{} signal is in principle detectable before
merger.  Effort from both the \GW{} and astronomy communities may make it
...
emission. We present one essential ingredient needed to report \GW{} candidates
not minutes after the merger, as has already been accomplished, but seconds
before.  This ingrediant is a computationally inexpensive low-latency filtering
algorithm for detecting inspiral signals in \GW{} data.  We also discuss the
...
short gamma-ray bursts (short \GRB{}s) \citep{Lee:2005, nakar07}.  In this
scenario, prompt gamma-ray emission arises on the accretion timescale of a
central compact object formed after the merger, $0.1$--$1.0$\,s
...
\textsc{ns}s.  An accompanying \GW{} observation would confirm the latter.
...
WaveBurst, and Omega \citep{HugheyGWPAW2011, S6lowlatency, S6lowlatency2, S6lowlatency3, S6lowlatency4}. The S6 analyses
...
prohibitively expensive for long templates.  We note that \citep{shaunIIR} have
explored an infinite-impulse-response (IIR) decomposition of \CBC\ waveforms as
a means to reduce the computational complexity of \TD\ filtering.  They
