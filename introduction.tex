...
x-rays and gamma-rays~\cite{Sari99}. \editorial{Should mention that optical flashes have been seen for a handful of long GRBs by very fast slews. TAROT has seen many within ~20 seconds. \cite{Klotz09}} In contrast, an
...
\editorial{Citation needed for LOOC-UP} The gravitational-wave community initiated a project to send alerts when
