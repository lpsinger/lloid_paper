...
\citep{Fairhurst2009}. Table~\ref{fig:earlywarning} and Fig.~\ref{fig:sky-localization-accuracy} estimate the
minimum 90\% confidence area versus time for a few rare, loud
coalescence events detectable by Advanced \LIGO{} and Advanced Virgo. A
once-per-year event would have minimum 90\% confidence areas of $1300$~deg$^2$
($3.1$\% of the sky) and $260$~deg$^2$ ($0.63$\% of the sky) at times 25~s and
10~s before coalescence, respectively. The confidence region shrinks
quadratically in area as the overall amplitude of the signal increases. By the
time of merger, the minimum 90\% confidence area shrinks to $0.82$~deg$^2$.
