...
\author{Kipp Cannon$^1$, Adrian Chapman$^2$, Chad Hanna$^3$, Drew Keppel$^4$, Antony C. Searle$^2$, Alan J. Weinstein$^2$} 

\address{$^1$ Canadian Institute for Theoretical Astrophysics, ON, Canada}
...
\address{$^3$ Albert-Einstein-Institut, Max-Planck-Institut f\"{u}r Gravitationphysik, Hannover, Germany}
