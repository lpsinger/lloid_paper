...
%
\editorial{We need to do this calculation using the \flops\ counts and the number of templates.}%
%
...
%
\editorial{This is redundant: 1/(16~Hz) and 125~ms are just reciprocals of each other.}%
%
