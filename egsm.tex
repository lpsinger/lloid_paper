...
\usepackage{multicol}
\setlength{\columnseprule}{0pt} %largeur trait séparateur
\setlength{\columnsep}{22pt}

%pour ecrire a coté des images
\usepackage{floatflt}
...
\author{Romain Cariou}
\title{Fiche résumé début de stage}
...
%$ \vphantom{\int_\int}$
 %\\
%\textbf{{\LARGE de l'expérience LIGO : Lloid}}
\begin{center}
\rule[1ex]{5cm}{0.15ex}
\end{center}
\end{center}
...
\resizebox{\linewidth}{!}{\includegraphics{geosamplemean.png}}
