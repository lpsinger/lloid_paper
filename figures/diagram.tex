...
\begin{tikzpicture}[
	...
	\node[junction, left=1.9cm of in0tee] (in0) {};
	\node[resample, left=1.75cm of in1tee] (in1) {\tiny$\downarrow$};
	\node[resample, left=1.75cm of in2tee] (in2) {\tiny$\downarrow$};
	...
	\node[signal, label=left:$x$, left=0.75cm of in0] (x) {};
	...
	\node[right=3.5cm of fir label,align=center] {Interpolation and \\ SNR accumulation \\ $\overbrace{\hspace{2.75cm}}^{}$};
	\node[left=0.3cm of fir label,align=center] {Decimation \\ of input \\ $\overbrace{\hspace{1cm}}^{}$};
