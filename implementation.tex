...
The \lloid\ algorithm is amenable to truly latency free, realtime implementation.
However, such a realtime search pipeline would likely require integration directly into
...
From the outputs of the \SVD\ basis filters, we form the partial \SNR streams for
each time  slice by multiplying by the reconstruction matrices.  This is accomplished
with the \texttt{gstlal} element \texttt{lal\_matrixmixer}.
