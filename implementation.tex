...
The \lloid\ algorithm is amenable to nearly latency free, real-time implementation.
However, such a near real-time search pipeline would likely require integration directly into
