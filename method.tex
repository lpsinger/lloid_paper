...
transform of the data and of the multiplication of the transforms.  By making the common
choice of an \fft\ block size of twice the length of the filter,
$\fftblock = 2 \tmpsamps$, this simplifies to $\approx 4 f^0 \numtmps \lg \fftblock$
\flops.
