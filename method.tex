...
$\bar{\theta}$%
%
\editorial{Change this to a harpoon or vector symbol.}
%
that determine the amplitude and phase evolution of the gravitational wave strain. For systems where the effects of spin can be ignored, the
...
for the waveforms $h(t,\bar{\theta})$, known as templates, are the waveforms
weighted by the inverse detector noise amplitude spectral density. To construct a template bank, templates are chosen with discrete signal parameters $\theta_1,\, \theta_2,\, \cdots$, $\theta_N$ to assure a
...
minimum match} of 0.97. Data are filtered against each template to produce an \SNR{}
