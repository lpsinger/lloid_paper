...
\Table{\label{table:flops}Minimum computational cost of the \textsc{fir} filter bank, \textsc{fft} convolution, and \lloid\ methods for a bank of 657 templates sampled at 4096 Hz.}
\br
Method & \flops \\
\mr
