...
\editorial{Need to convert some continuous time notation to discrete time here.}Rather than applying a unique time-slice decomposition to each template
...
x_i(\tau) \approx \sum_k^{\numslices} y_{ik}(\tau)
\end{equation}
where \numslices\ is the number of time slices required.  We note that
