...
\editorial{Drew: It would be good to have these numbers for with SVD only, with SVD + TIME SLICES, and SVD+COMPDETSTAT. Then we can show which combination allows you to save time.}
\begin{table}[!h]
