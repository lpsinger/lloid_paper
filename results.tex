...
previous sub sections to set the \SVD\ tolerance to $1-10^{-4}$  and the
interpolation filter length to 16.  We find that the \lloid\ method provides
comparable performance to the standard \FD\ approach but with no intrinsic
latency.  Table \ref{table:flops} lists the costs for filtering this sub-bank.
%
